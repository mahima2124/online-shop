...
function SignUp() {
  ...
  const submitForm = () => {
    const allData = ({
      ...data, name: data.name, email: data.email, phone: data.phone, password: data.password,
    });
    if (setData) {
      navigate('/login');
    }
    const prevData = JSON.parse(localStorage.getItem('values'));
    localStorage.setItem('values', JSON.stringify([...prevData, allData]));
  };
        ...
        <div className="login-form">
          ...
          <div className="form">
            <div className="input-group">
              <i className="fa fa-user form-icon" aria-hidden="true" />
            ...
            <div className="input-group">
              <i className="fa fa-phone-square form-icon" aria-hidden="true" />
